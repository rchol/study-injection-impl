...
import api.json.Mapper;
import api.json.MappingJsonParser;
import api.json.StreamingJsonParser;
import api.json.impl.ImplementedJsonParser;
import api.json.impl.MyJSONPrimitive;
import api.json.impl.ReflectionMapper;
...
public class MappingJsonParserTest {
    ...
    private static StreamingJsonParser sjp = new ImplementedJsonParser();
